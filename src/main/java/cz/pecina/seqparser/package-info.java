 ...
 * parameters.
 *
 * <p>Example: <code>-short "Hello world!",par1=15 --long-option --long-option 0 --short "Done."</code>
 *
 ...
 * for <em>two</em> positional parameters, both empty. Similarly, <code>-option par=</code> sets the parameter "par"
 * to an empty string.
 *
